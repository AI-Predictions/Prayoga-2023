...
# Load the dataset
data = pd.read_csv('train-data.csv') # Replace with your dataset file path
...
#X_train, X_test, y_train, y_test = train_test_split(X_encoded, y, test_size = 0.1, random_state = 1)#104 = 76% 0.1 = 88% 0.3=80%
